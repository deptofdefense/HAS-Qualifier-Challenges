...
{
  /* cmd num, <---- cmd exe time ---->   <---------------------------- cmd pkt primary header ---------------------------->  <----- cmd pkt 2nd header ---->   <-- opt data ---> */
           1, CMD1_TIME_A, CMD1_TIME_B,  CFE_MAKE_BIG16(SC_CMD_MID), CFE_MAKE_BIG16(PKT_FLAGS), CFE_MAKE_BIG16(CMD1_LENGTH), ((CMD1_XSUM << 8) | SC_NOOP_CC),
           2, CMD2_TIME_A, CMD2_TIME_B,  CFE_MAKE_BIG16(SC_CMD_MID), CFE_MAKE_BIG16(PKT_FLAGS), CFE_MAKE_BIG16(CMD2_LENGTH), ((CMD2_XSUM << 8) | SC_ENABLE_RTS_CC), CMD2_ARG,
           3, CMD3_TIME_A, CMD3_TIME_B,  CFE_MAKE_BIG16(SC_CMD_MID), CFE_MAKE_BIG16(PKT_FLAGS), CFE_MAKE_BIG16(CMD3_LENGTH), ((CMD3_XSUM << 8) | SC_START_RTS_CC), CMD3_ARG,
           4, CMD4_TIME_A, CMD4_TIME_B,  CFE_MAKE_BIG16(SC_CMD_MID), CFE_MAKE_BIG16(PKT_FLAGS), CFE_MAKE_BIG16(CMD4_LENGTH), ((CMD4_XSUM << 8) | SC_RESET_COUNTERS_CC),
           0, 0, 0, 0, 0, 0, 0
};
#endif
/************************/
