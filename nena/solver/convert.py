...
start_seq = '11010110011111111110000011101' #1ACFFC1D
alt_start_seq = '01010110011111111110000011101' # 9ACFFC1D
end_seq = 'BEEF'
...
def convert_bit_stream(bit_stream):
    ...
    while i < len(bit_data):
        if bit_data[i:i+len(start_seq)] == start_seq or \
            ...
            extracted_bin_data = bit_data[i+len(start_seq):]
