...
By default, this file lives in ``/challenge/local_config.toml``.
...
.. warning::
    ...
    Any ad-hoc config changes made to the ``/challenge/local_config.toml`` file will be lost if the OS is
