...
The Kubos service system relies on a configuration file in `/challenge/local_config.toml` in order to know which IP ports should be used for which service.
