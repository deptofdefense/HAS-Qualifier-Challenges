...
//! # Configuration
//!
//! The service can be configured in the `/challenge/local_config.toml` with the following fields:
//!
//! ```
//! [tel-service]
...
fn main() {
    Logger::init("kubos-tel-service").unwrap();

    let config = Config::new("tel-service")
        .map_err(|err| {
