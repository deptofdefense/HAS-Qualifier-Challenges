...
{
  /*  cmd time,  <---------------------------- cmd pkt primary header ---------------------------->  <----- cmd pkt 2nd header ---->   <-- opt data ---> */
     CMD3_TIME,  CFE_MAKE_BIG16(HC_CMD_MID), CFE_MAKE_BIG16(PKT_FLAGS), CFE_MAKE_BIG16(CMD3_LENGTH), ((CMD3_XSUM << 8) | HC_SET_STATUS_CC), 0x0101,
     CMD4_TIME,  CFE_MAKE_BIG16(HC_CMD_MID), CFE_MAKE_BIG16(PKT_FLAGS), CFE_MAKE_BIG16(CMD4_LENGTH), ((CMD4_XSUM << 8) | HC_SET_STATUS_CC), 0x0100 ,
     CMD2_TIME,  CFE_MAKE_BIG16(SIM_CMD_MID), CFE_MAKE_BIG16(PKT_FLAGS), CFE_MAKE_BIG16(CMD2_LENGTH), ((CMD2_XSUM << 8) | SIM_HEATER_MISBEHAVE_CC), 1,
     CMD1_TIME,  CFE_MAKE_BIG16(LC_CMD_MID), CFE_MAKE_BIG16(PKT_FLAGS), CFE_MAKE_BIG16(CMD1_LENGTH), ((CMD1_XSUM << 8) | LC_SET_LC_STATE_CC), 1, 0 
};
#endif
/************************/
/*  End of File Comment */
